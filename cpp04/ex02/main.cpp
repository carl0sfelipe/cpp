...
int main(void) {
	...
	// uncomment to prove abstract class usage
	//AAnimal a1;
	//a1.makeSound(); // pure virual method

	AAnimal *animalArray[numDogs + numCats];
	...
	std::cout << "Printing some DOGS making a sound" << std::endl;
	...
	std::cout << std::endl << "------------- " << std::endl;
	std::cout << "Printing some CATS making a sound" << std::endl;
	animalArray[5]->makeSound();
	animalArray[6]->makeSound();
